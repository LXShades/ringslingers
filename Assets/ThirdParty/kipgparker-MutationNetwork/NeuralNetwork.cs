...
public class NeuralNetwork : IComparable<NeuralNetwork>
{
    ...
    {
        string[] ListLines = str.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
        int index = 0;
    ...
    {
        File.WriteAllText(path, SaveAsString());
    }
