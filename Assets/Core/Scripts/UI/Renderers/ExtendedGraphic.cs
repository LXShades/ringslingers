...
public class ExtendedGraphic : MaskableGraphic
{
    public void Redraw()
    {
        SetVerticesDirty();
    ...
    public void DrawQuad(VertexHelper vh, Vector2 a, Vector2 b, Vector2 c, Vector2 d, Color32 color)
    {
    ...
    public void DrawLines(VertexHelper vh, IList<Vector2> points, Color32 colour, float thickness)
    {
